...
-->
                    ...
                    <nav class="main-nav">
                        ...
                        -->
                            ...
                            <li class="scroll-to-section">
                                @auth
                                <a class="" href="{{url('/show_cart',Auth::user()->id)}}">
                                Cart[{{$count}}]
                                </a>
                                @endauth
    ...
    <div id="top" align="center" style="margin-left:100px;">
        ...
        <table align="center">
            ...
            <tr align="center" style="background-color: rgb(175, 190, 133);">
            ...
            <tr style="position: relative;top:-85px;right:-420px;">
            <td>
